...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      "A request route and contact details can be added here once they are confirmed. Until then, requests are handled through the founder-approved commercial route.",
    ],
  },
  {
